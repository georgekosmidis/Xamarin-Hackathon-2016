...
using XDevMessaging.UWP;
using XDevMessaging.UWP.PushNotifications;

[assembly: Xamarin.Forms.Dependency(typeof(UWPNotificationsChannelProvider))]
namespace XDevMessaging.UWP.PushNotifications
{
    public class UWPNotificationsChannelProvider : INotificationsChannelProvider
    {
